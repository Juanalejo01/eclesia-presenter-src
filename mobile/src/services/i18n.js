...
export const DICT = {
  ...
  es: {
    ...
    // ----- Flujo dual: mando LAN vs preparación cloud (C4) -----
    'dualMode.chipLive':         'En vivo · PC',
    'dualMode.chipCloud':        'Nube',
    'dualMode.chipLiveOnAria':   'Sección de mando en vivo, conectada al PC',
    'dualMode.chipLiveOffAria':  'Sección de mando en vivo, sin conexión con el PC',
    'dualMode.chipCloudAria':    'Sección en la nube, funciona sin el PC',
    'dualMode.hintAria':         'Cómo preparar el culto sin el PC',
    'dualMode.title':            'Esto es el mando en vivo',
    'dualMode.needPc':           'Necesitas tu PC encendido y en la misma WiFi para controlar la proyección desde aquí.',
    'dualMode.prepareFromHere':  'Para preparar el culto ahora mismo desde el móvil, usa Canciones › Mi nube o Mis listas. Funcionan sin el PC.',
    'dualMode.gotoSongs':        'Canciones · Mi nube',
    'dualMode.gotoSongsAria':    'Ir a tus canciones en la nube',
    'dualMode.gotoPlans':        'Mis listas',
    'dualMode.gotoPlansAria':    'Ir a tus listas en la nube',
    'dualMode.compactBody':      'Sin el PC no puedes proyectar, pero sí preparar el culto:',
    'dualMode.compactLink':      've a tus canciones en la nube',
    'dualMode.pairPrepCloud':    'Solo quiero preparar el culto (sin PC)',
    'dualMode.pairPrepCloudAria': 'Preparar el culto en la nube sin emparejar el PC',
  ...
  en: {
    ...
    'dualMode.chipLive':         'Live · PC',
    'dualMode.chipCloud':        'Cloud',
    'dualMode.chipLiveOnAria':   'Live control section, connected to the PC',
    'dualMode.chipLiveOffAria':  'Live control section, no connection to the PC',
    'dualMode.chipCloudAria':    'Cloud section, works without the PC',
    'dualMode.hintAria':         'How to prepare the service without the PC',
    'dualMode.title':            'This is the live remote',
    'dualMode.needPc':           'You need your PC on and on the same WiFi to control the projection from here.',
    'dualMode.prepareFromHere':  'To prepare the service right now from your phone, use Songs › My cloud or My lists. They work without the PC.',
    'dualMode.gotoSongs':        'Songs · My cloud',
    'dualMode.gotoSongsAria':    'Go to your cloud songs',
    'dualMode.gotoPlans':        'My lists',
    'dualMode.gotoPlansAria':    'Go to your cloud lists',
    'dualMode.compactBody':      'Without the PC you cannot project, but you can prepare the service:',
    'dualMode.compactLink':      'go to your cloud songs',
    'dualMode.pairPrepCloud':    'I just want to prepare the service (no PC)',
    'dualMode.pairPrepCloudAria': 'Prepare the service in the cloud without pairing the PC',
  ...
  pt: {
    ...
    'dualMode.chipLive':         'Ao vivo · PC',
    'dualMode.chipCloud':        'Nuvem',
    'dualMode.chipLiveOnAria':   'Seção de controle ao vivo, conectada ao PC',
    'dualMode.chipLiveOffAria':  'Seção de controle ao vivo, sem conexão com o PC',
    'dualMode.chipCloudAria':    'Seção na nuvem, funciona sem o PC',
    'dualMode.hintAria':         'Como preparar o culto sem o PC',
    'dualMode.title':            'Isto é o controle ao vivo',
    'dualMode.needPc':           'Você precisa do seu PC ligado e no mesmo WiFi para controlar a projeção daqui.',
    'dualMode.prepareFromHere':  'Para preparar o culto agora pelo celular, use Cânticos › Minha nuvem ou Minhas listas. Funcionam sem o PC.',
    'dualMode.gotoSongs':        'Cânticos · Minha nuvem',
    'dualMode.gotoSongsAria':    'Ir para seus cânticos na nuvem',
    'dualMode.gotoPlans':        'Minhas listas',
    'dualMode.gotoPlansAria':    'Ir para suas listas na nuvem',
    'dualMode.compactBody':      'Sem o PC você não projeta, mas pode preparar o culto:',
    'dualMode.compactLink':      'vá para seus cânticos na nuvem',
    'dualMode.pairPrepCloud':    'Só quero preparar o culto (sem PC)',
    'dualMode.pairPrepCloudAria': 'Preparar o culto na nuvem sem parear o PC',
